INSERT INTO fin_interval_type(id, name) VALUES
  (1, "DAY"),
  (2, "WEEK"),
  (3, "MONTHLY"),
  (4, "YEARLY");

INSERT INTO fin_category(id, name, active) VALUES
  (1, "Active real accounts", 1),
  (2, "Passive real accounts", 0),
  (3, "Expense accounts", 1),
  (4, "Income accounts", 0);

INSERT INTO fin_account(id, name, note, parent_account, category_id) VALUES
  ...
  (1802, "Girokonto KSK Esslingen-Nürtingen", NULL, 1800, 1),
  (6100, "Löhne & Gehälter", NULL, NULL, 4),
  (6101, "Gehalt Tutorium HFT", NULL, 6100, 4);

INSERT INTO fin_transaction(account, contra_account, amount, note) VALUES
